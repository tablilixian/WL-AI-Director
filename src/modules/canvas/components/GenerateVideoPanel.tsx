...
import { Plus, GripVertical, Trash2, ChevronDown, Sparkles, Camera, Sun, Mic, Settings, Film, Clock, X, Maximize2, Eye, EyeOff } from 'lucide-react';
...
export const GenerateVideoPanel: React.FC<GenerateVideoPanelProps> = ({ selectedLayerIds, initialConfig, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const cameraPrompt = cameraMove && selectedCamera !== 'none'
