...
export const CanvasToolbar: React.FC = () => {
  ...
  const hasMultipleImageSelection =
    ...
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1 bg-gray-800/90 backdrop-blur-sm rounded-lg p-1.5 shadow-lg border border-gray-700">
      <div className="relative" ref={toolRef}>
        ...
        >
          ...
          <svg
            className={`w-3 h-3 transition-transform ${isToolOpen ? 'rotate-180' : ''}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {isToolOpen && (
          <div
            className="absolute top-full left-0 mt-1.5 bg-gray-800 border border-gray-700 rounded-lg shadow-xl py-1 min-w-[140px] z-[100]"
        ...
        <>
          <div className="relative" ref={layerRef}>
            ...
            >
              ...
              <span>图层</span>
              <svg
                className={`w-3 h-3 transition-transform ${isLayerOpen ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {isLayerOpen && (
              <div
                className="absolute top-full left-0 mt-1.5 bg-gray-800 border border-gray-700 rounded-lg shadow-xl py-1 min-w-[180px] z-[100]"
                onClick={(e) => e.stopPropagation()}
              >
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-xs text-gray-300 hover:bg-gray-700 hover:text-white flex items-center gap-2"
                >
                  <svg
                ...
                <div className="px-3 py-2">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setLayerOpacity(selectedLayerId, parseInt(e.target.value) / 100)
                      }
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-xs text-gray-300 hover:bg-gray-700 hover:text-white flex items-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                  编组
                </button>
          ...
          <div className="relative" ref={arrangeRef}>
            ...
            >
              ...
              <span>对齐</span>
              <svg
                className={`w-3 h-3 transition-transform ${isArrangeOpen ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <span className="px-2 text-xs text-gray-400">{layers.length} layers</span>
    </div>
  );
};
