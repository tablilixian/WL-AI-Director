...
export const InlinePanoramaViewer: React.FC<InlinePanoramaViewerProps> = ({
  ...
  return (
    ...
    >
      ...
      {showToolbar && (
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-1 bg-black/60 rounded-lg px-2 py-1 z-10">
          {onToggleFlat && (
            <button
          ...
          <span className="text-[10px] text-white/60 font-mono min-w-[32px] text-center">{zoomPercent}%</span>
          {onOpenFullscreen && (
            <button
              className="p-1 rounded hover:bg-white/20 text-white/80 hover:text-white transition-colors"
              title="全屏查看"
