...
export type DrawingTool = 'select' | 'pencil' | 'rectangle' | 'arrow';
...
export interface LayerData {
  ...
  operationType?: 'text-to-image' | 'image-to-image' | 'text-to-video' | 'image-to-video' | 'style-transfer' | 'direct-style-transfer' | 'ipa-style-transfer' | 'background-replace' | 'expand' | 'background-remove' | 'variant' | 'import' | 'drawing' | 'multi-angle' | 'three-view' | 'storyboard-deduction' | 'lighting' | '9grid' | '4grid' | '25grid' | 'inpaint' | 'visual-language'; // 操作类型
  // 宫格生成数据（用于后续宫格拆分）
